...
|||
||| @ res The return type of the result.
||| @ in_effects The list of allowed side-effects.
||| @ out_effects Function to compute a new list of allowed side-effects.
data EffM : (m : Type -> Type) -> (res : Type)
            -> (in_effects : List EFFECT)
            -> (out_effects : res -> List EFFECT) -> Type where
